...
public class ServerSync : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string motorSpeedJsonBody = "{\"function\": 2,\"distance\": 600}";
    ...
    {
        int angle0 = (int)((servos[0].transform.position.z + 8.9)/1.53 * 80) + 100;
        int angle1 = (int)((servos[1].transform.position.z + 9)/1.63 * 80) + 100;
        int angle2 = (int)((servos[2].transform.position.z + 9)/1.63 * 80) + 100;
        int angle3 = (int)((servos[3].transform.position.z + 9)/1.63 * 80) + 100;
